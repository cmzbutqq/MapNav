...
class Dijkstra {
  public:
    Dijkstra(Map *map, int startVertexId, int endVertexId,
...
class TrafficAwareDijkstra {
  public:
    TrafficAwareDijkstra(Map *map, int startVertexId, int endVertexId,
                         bool considerAccident);
    PathResult findPath();
...
class RouteThroughPoints {
  public:
    RouteThroughPoints(Map *map, const std::vector<int> &points,
                       bool considerAccident);
...
class EfficientRouteThroughPointsUnordered {
  public:
    EfficientRouteThroughPointsUnordered(Map *map,
